...
(14, 1, '014.jpg', '大武山牧場履歷蛋-白殼(10粒裝)', 300, '品名：大武山牧場履歷蛋-白殼\r\n淨重：L號蛋 /60zg以上/盒\r\n10粒裝', '', ''),
...
(25, 2, '025.jpg', 'thermos 膳魔師厚鑄耐摩不沾鍋_kfb系列單柄平底鍋2', 1530, '尺寸 43.5×25.5×6 (約長x寬x高cm)\n重量 860 (約g)\n鍋身材質 不沾塗層：PTFE\n把手：電木\n鍋身本體：鋁合金 \n導磁底：SUS430不銹鋼\n鍋身外層：烤漆\n定價 NT$1,800元', '', ''),
...
--
ALTER TABLE `order_main_list`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT COMMENT '這就是訂單編號', AUTO_INCREMENT=8;
