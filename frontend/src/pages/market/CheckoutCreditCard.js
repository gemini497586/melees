...
function CheckoutCreditCard() {
    return ( < >
        ...
        <
        input type = "text"
        className = "checkout-credit-card-num credit1" / >
        <
        input type = "text"
        className = "checkout-credit-card-num credit2" / >
        <
        input type = "text"
        className = "checkout-credit-card-num credit3" / >
        <
        input type = "text"
        className = "checkout-credit-card-num credit4" / >
        <
        /div> < /
        div > <
        ...
        input type = "text"
        className = "checkout-credit-card-input ep1" / >
        <
        input type = "text"
        className = "checkout-credit-card-input ep2" / >
        <
        /div> <
        ...
        input type = "text"
        className = "checkout-credit-card-input" / >
        <
        /div> <
